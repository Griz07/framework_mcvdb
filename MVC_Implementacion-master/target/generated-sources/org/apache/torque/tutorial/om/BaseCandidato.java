 ...
 *
 * [Thu Nov 27 14:55:21 CST 2014]
 *
 * You should not use this class directly.  It should not even be
 * extended; all references should be to Candidato
 */
public abstract class BaseCandidato 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1417121721618L;
    ...
    /**
     * Set the value of candidatoId.
     * The field is described as follows: 
     * Candidato Id
     *
     * @param v new value
     */
    public void setCandidatoId(int v)
    {
        if (this.candidatoId != v)
        {
            setModified(true);
        }
    ...
    /**
     * Set the value of numVotos.
     * The field is described as follows: 
     * numero de votos del candidato
     *
     * @param v new value
     */
    public void setNumVotos(int v)
    {
        if (this.numVotos != v)
        {
            setModified(true);
    ...
    static
    {
        ...
        fieldNames.add("CandidatoId");
        fieldNames.add("Nombre");
        fieldNames.add("NumVotos");
    ...
    {
        if (name.equals("CandidatoId"))
        {
            return new Integer(getCandidatoId());
        }
        if (name.equals("Nombre"))
        {
            return getNombre();
        }
        if (name.equals("NumVotos"))
        {
            return new Integer(getNumVotos());
        }
        return null;
    }
        ...
        throws TorqueException, IllegalArgumentException
    {
        if (name.equals("CandidatoId"))
        {
            ...
            setCandidatoId(((Integer) value).intValue());
            return true;
        }
        if (name.equals("Nombre"))
        {
        ...
        if (name.equals("NumVotos"))
        {
            ...
            setNumVotos(((Integer) value).intValue());
            return true;
        }
        return false;
    }
    ...
    {
        if (name.equals(org.apache.torque.tutorial.om.CandidatoPeer.CANDIDATO_ID))
        {
            return new Integer(getCandidatoId());
        }
        if (name.equals(org.apache.torque.tutorial.om.CandidatoPeer.NOMBRE))
        {
            return getNombre();
        }
        if (name.equals(org.apache.torque.tutorial.om.CandidatoPeer.NUM_VOTOS))
        {
            return new Integer(getNumVotos());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
        if (org.apache.torque.tutorial.om.CandidatoPeer.CANDIDATO_ID.getSqlExpression().equals(name))
        {
            return setByName("CandidatoId", value);
        }
        if (org.apache.torque.tutorial.om.CandidatoPeer.NOMBRE.getSqlExpression().equals(name))
        {
            return setByName("Nombre", value);
        }
        if (org.apache.torque.tutorial.om.CandidatoPeer.NUM_VOTOS.getSqlExpression().equals(name))
        {
            return setByName("NumVotos", value);
        }
        return false;
    }
    ...
    {
        save(CandidatoPeer.DATABASE_NAME);
    }
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CandidatoPeer.doInsert((Candidato) this, con);
                    setNew(false);
                }
                else
                {
                    CandidatoPeer.doUpdate((Candidato) this, con);
                }
            }
     ...
     *
     * @param key candidatoId ObjectKey
     */
    public void setPrimaryKey(ObjectKey key)
        
    {
        setCandidatoId(((NumberKey) key).intValue());
    }
    ...
    {
        setCandidatoId(Integer.parseInt(key));
    }
    ...
    {
        return SimpleKey.keyFor(getCandidatoId());
    }
     ...
     */
    public Candidato copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public Candidato copy(Connection con) throws TorqueException
    {
     ...
     */
    public Candidato copy(boolean deepcopy) throws TorqueException
    {
        Candidato candidato = new Candidato();

        return copyInto(candidato, deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public Candidato copy(boolean deepcopy, Connection con) throws TorqueException
    {
        Candidato candidato = new Candidato();

        return copyInto(candidato, deepcopy, con);
    }
     ...
     */
    public Candidato copyInto(Candidato copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    public Candidato copyInto(Candidato copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected Candidato copyInto(Candidato copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setCandidatoId(0);
        copyObj.setNombre(nombre);
        copyObj.setNumVotos(numVotos);
     ...
     * @param con the database connection to read associated objects.
     */
    public Candidato copyInto(Candidato copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setCandidatoId(0);
        copyObj.setNombre(nombre);
        copyObj.setNumVotos(numVotos);
    ...
    /** The Peer class */
    private static final org.apache.torque.tutorial.om.CandidatoPeer peer
            = new org.apache.torque.tutorial.om.CandidatoPeer();
     ...
     */
    public org.apache.torque.tutorial.om.CandidatoPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return org.apache.torque.tutorial.om.CandidatoPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("Candidato:\n");
        str.append("candidatoId = ")
           .append(getCandidatoId())
           .append("\n");
        str.append("nombre = ")
           .append(getNombre())
           .append("\n");
    ...
    public boolean equals(Object toCompare)
    {
        ...
        Candidato other = (Candidato) toCompare;
     ...
     */
    public boolean valueEquals(Candidato toCompare)
    {
        if (toCompare == null)
        {
            return false;
        ...
        if (this.candidatoId != toCompare.getCandidatoId())
        {
            return false;
        }
        ...
        if (this.numVotos != toCompare.getNumVotos())
        {
            return false;
        }
        return true;
