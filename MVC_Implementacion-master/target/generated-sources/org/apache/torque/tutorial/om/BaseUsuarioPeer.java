...
public abstract class BaseUsuarioPeer
{
    /** The class log. */
    ...
    /** The column for the usuario_id field */
    public static final ColumnMap USUARIO_ID;
    ...
    /** The column for the rol field */
    public static final ColumnMap ROL;
    ...
    private static UsuarioPeerImpl usuarioPeerImpl;
    ...
    static
    {
        DatabaseMap dbMap = Torque.getOrCreateDatabase("mvcdb")
                .getDatabaseMap();
        if (dbMap.getTable("usuario") == null)
        {
            dbMap.addTable("usuario");
        }
        DATABASE_NAME = "mvcdb";
        TABLE_NAME = "usuario";

        TABLE = dbMap.getTable("usuario");
        TABLE.setJavaName("Usuario");
        TABLE.setOMClass(org.apache.torque.tutorial.om.Usuario.class);
        TABLE.setPeerClass(org.apache.torque.tutorial.om.UsuarioPeer.class);
        TABLE.setDescription("Tabla de Usuarios");
        TABLE.setPrimaryKeyMethod(IDMethod.NATIVE);
        TABLE.setPrimaryKeyMethodInfo(IDMethod.ID_BROKER, TABLE.getName());
        TABLE.setPrimaryKeyMethodInfo(IDMethod.SEQUENCE, "usuario_SEQ");
        TABLE.setPrimaryKeyMethodInfo(IDMethod.AUTO_INCREMENT, "usuario");
        TABLE.setUseInheritance(true);


    // ------------- Column: usuario_id --------------------
        USUARIO_ID = new ColumnMap("usuario_id", TABLE);
        USUARIO_ID.setType(Integer.valueOf(0));
        USUARIO_ID.setTorqueType("INTEGER");
        USUARIO_ID.setUsePrimitive(true);
        USUARIO_ID.setPrimaryKey(true);
        USUARIO_ID.setNotNull(true);
        USUARIO_ID.setJavaName("UsuarioId");
        USUARIO_ID.setAutoIncrement(true);
        USUARIO_ID.setProtected(false);
        USUARIO_ID.setJavaType( "int" );
        USUARIO_ID.setDescription("Usuario Id");
        USUARIO_ID.setPosition(1);
        TABLE.addColumn(USUARIO_ID);
    // ------------- Column: nombre --------------------
        ...
        NOMBRE.setDescription("Nombre usuario");
        NOMBRE.setSize(128);
    ...
    // ------------- Column: password --------------------
        ...
        PASSWORD.setDescription("password del candidato");
        PASSWORD.setSize(128);
        PASSWORD.setPosition(3);
        TABLE.addColumn(PASSWORD);
    // ------------- Column: rol --------------------
        ROL = new ColumnMap("rol", TABLE);
        ROL.setType("");
        ROL.setTorqueType("VARCHAR");
        ROL.setUsePrimitive(false);
        ROL.setPrimaryKey(false);
        ROL.setNotNull(true);
        ROL.setJavaName("Rol");
        ROL.setAutoIncrement(true);
        ROL.setProtected(false);
        ROL.setJavaType( "String" );
        ROL.setDescription("rol del candidato");
        ROL.setSize(128);
        ROL.setPosition(4);
        TABLE.addColumn(ROL);
     ...
     */
    protected static UsuarioPeerImpl createUsuarioPeerImpl()
    {
        UsuarioPeerImpl instance = new UsuarioPeerImpl();
        return instance;
    }
     ...
     */
    public static UsuarioPeerImpl getUsuarioPeerImpl()
    {
        UsuarioPeerImpl peerImplInstance = usuarioPeerImpl;
        if (peerImplInstance == null)
        {
            peerImplInstance = UsuarioPeer.createUsuarioPeerImpl();
            usuarioPeerImpl = peerImplInstance;
        }
     ...
     */
    public static void setUsuarioPeerImpl(UsuarioPeerImpl peerImplInstance)
    {
        usuarioPeerImpl = peerImplInstance;
    }
    ...
    {
        getUsuarioPeerImpl().addSelectColumns(criteria);
    }
    ...
    {
        getUsuarioPeerImpl().correctBooleans(criteria);
    }
    ...
    public static void correctBooleans(
        ...
        throws TorqueException
    {
        getUsuarioPeerImpl().correctBooleans(columnValues);
    }
    
    /**
     * Selects Usuario objects from a database.
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Usuario> doSelect(Criteria criteria)
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelect(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Usuario> doSelect(
                Criteria criteria,
                Connection connection)
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelect(criteria, connection);
    }
    ...
    public static <T> List<T> doSelect(
            ...
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelect(criteria, mapper);
    }
    ...
    public static <T> List<T> doSelect(
        ...
        throws TorqueException
    {
        return getUsuarioPeerImpl().doSelect(
                criteria,
                mapper,
                connection);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Usuario> doSelect(Usuario obj)
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelect(obj);
    }

    /**
     * Selects at most one Usuario object from a database.
     *
     * @param criteria object used to create the SELECT statement.
     *
     ...
     */
    public static Usuario doSelectSingleRecord(
                Criteria criteria)
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelectSingleRecord(criteria);
    }
    ...
    public static Usuario doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelectSingleRecord(criteria, connection);
    }
    ...
    public static <T> T doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelectSingleRecord(
                criteria,
                mapper);
    }
    ...
    public static Usuario doSelectSingleRecord(
            ...
            throws TorqueException
    {
        return getUsuarioPeerImpl().doSelectSingleRecord(obj);
    }
     ...
     */
    public static Usuario getDbObjectInstance()
    {
        return getUsuarioPeerImpl().getDbObjectInstance();
    }
    ...
    public static ObjectKey doInsert(ColumnValues columnValues) 
            throws TorqueException
    {
        return getUsuarioPeerImpl().doInsert(columnValues);
    }
    ...
    public static ObjectKey doInsert(ColumnValues columnValues, Connection con)
            throws TorqueException
    {
        return getUsuarioPeerImpl().doInsert(columnValues, con);
    }
    /**
     * Method to do inserts
     *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Usuario obj)
            throws TorqueException
    {
        getUsuarioPeerImpl().doInsert(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Usuario obj, Connection con)
            throws TorqueException
    {
        getUsuarioPeerImpl().doInsert(obj, con);
    }
    ...
    {
        return getUsuarioPeerImpl().doUpdate(columnValues);
    }
    ...
    public static int doUpdate(ColumnValues columnValues, Connection con)
        throws TorqueException
    {
        return getUsuarioPeerImpl().doUpdate(columnValues, con);
    }
    ...
    public static int doUpdate(
            ...
            throws TorqueException
    {
        return getUsuarioPeerImpl().doUpdate(
            selectCriteria,
            updateValues);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Usuario obj) throws TorqueException
    {
        return getUsuarioPeerImpl().doUpdate(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doUpdate(Usuario obj, Connection con)
        throws TorqueException
    {
        return getUsuarioPeerImpl().doUpdate(obj, con);
    }
    ...
    public static int executeStatement(String statementString) 
            throws TorqueException
    {
        return getUsuarioPeerImpl().executeStatement(statementString);
    }
    ...
    public static int executeStatement(
            ...
            throws TorqueException
    {
        return getUsuarioPeerImpl().executeStatement(
                statementString, 
                replacementValues);
    }
     ...
     */
     ...
     {
        return getUsuarioPeerImpl().doDelete(criteria);
     }
    ...
    *
     ...
     */
     public static int doDelete(Criteria criteria, Connection con)
        throws TorqueException
     {
        return getUsuarioPeerImpl().doDelete(criteria, con);
     }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Usuario obj) throws TorqueException
    {
        return getUsuarioPeerImpl().doDelete(obj);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Usuario obj, Connection con)
        throws TorqueException
    {
        return getUsuarioPeerImpl().doDelete(obj, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static int doDelete(Collection<Usuario> objects)
            throws TorqueException
    {
        return getUsuarioPeerImpl().doDelete(objects);
    }
    ...
    public static int doDelete(
        ...
        throws TorqueException
    {
        return getUsuarioPeerImpl().doDelete(objects, con);
    }
    ...
    {
        return getUsuarioPeerImpl().doDelete(pk);
    }
    ...
    public static int doDelete(ObjectKey pk, Connection con)
        throws TorqueException
    {
        return getUsuarioPeerImpl().doDelete(pk, con);
    }
    ...
    {
        return getUsuarioPeerImpl().buildCriteria(pk);
    }
    ...
    {
        return getUsuarioPeerImpl().buildCriteria(pks);
    }
    ...
    public static Criteria buildPkCriteria(
            Collection<Usuario> objects)
    {
        return getUsuarioPeerImpl().buildPkCriteria(objects);
    }
     ...
     */
    public static Criteria buildCriteria(Usuario obj)
    {
        return getUsuarioPeerImpl().buildCriteria(obj);
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public static Criteria buildSelectCriteria(Usuario obj)
    {
        return getUsuarioPeerImpl().buildSelectCriteria(obj);
    }
     ...
     *         (should not happen).
     */
    public static ColumnValues buildColumnValues(Usuario usuario)
            throws TorqueException
    {
        
        return getUsuarioPeerImpl().buildColumnValues(usuario);
    }
     ...
     */
    public static Usuario retrieveByPK(int pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getUsuarioPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Usuario retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getUsuarioPeerImpl().retrieveByPK(pk, con);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Usuario retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getUsuarioPeerImpl().retrieveByPK(pk);
    }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Usuario retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        return getUsuarioPeerImpl().retrieveByPK(pk, con);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Usuario> retrieveByPKs(Collection<ObjectKey> pks)
        throws TorqueException
    {
        return getUsuarioPeerImpl().retrieveByPKs(pks);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Usuario> retrieveByPKs(Collection<ObjectKey> pks, Connection con)
        throws TorqueException
    {
        return getUsuarioPeerImpl().retrieveByPKs(pks,con);
    }
    ...
    public static TableMap getTableMap()
        throws TorqueException
    {
        return getUsuarioPeerImpl().getTableMap();
    }
